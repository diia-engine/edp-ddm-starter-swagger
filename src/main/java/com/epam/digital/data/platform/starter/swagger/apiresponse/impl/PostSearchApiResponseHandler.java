...
@Component
public class PostSearchApiResponseHandler extends PostApiResponseHandler {

  public PostSearchApiResponseHandler(
  ...
  public boolean isApplicable(HandlerMethod handlerMethod) {
    return super.isApplicable(handlerMethod) &&
        handlerMethod.getMethod().getName().startsWith("search");
  }
