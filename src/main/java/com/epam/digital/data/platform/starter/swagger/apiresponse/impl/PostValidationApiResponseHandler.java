...
@Component
public class PostValidationApiResponseHandler extends PostApiResponseHandler {

  public PostValidationApiResponseHandler(
  ...
  public boolean isApplicable(HandlerMethod handlerMethod) {
    return super.isApplicable(handlerMethod) &&
        handlerMethod.getMethod().getName().startsWith("validate");
  }
