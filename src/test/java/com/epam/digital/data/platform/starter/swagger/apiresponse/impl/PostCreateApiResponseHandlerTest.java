...
class PostCreateApiResponseHandlerTest {

  private static final String OPERATION_CODE = "post-create";
  ...
  void beforeEach() {
    apiResponseHandler =
        new PostCreateApiResponseHandler(messageSourceAccessor, openApiResponseProperties);

    lenient().when(openApiResponseProperties.getCodes())
  ...
  @Test
  void expectIsApplicableWhenMethodNameStartsWithCreate() throws NoSuchMethodException {
  ...
  @Test
  void expectIsNotApplicableWhenMethodNameNotStartsWithCreate() throws NoSuchMethodException {
    HandlerMethod handlerMethod =
